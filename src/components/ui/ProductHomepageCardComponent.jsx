...
export default function ProductHomepageCardComponent() {
  return (
    <div className="group relative w-full max-w-md mt-32 h-[700px] bg-gradient-to-br from-pink-50 to-white rounded-[2rem] p-8 flex flex-col justify-between overflow-hidden border border-pink-100 shadow-[0_20px_50px_rgba(236,72,153,0.05)] transition-all duration-500 hover:shadow-[0_40px_80px_rgba(236,72,153,0.1)] hover:-translate-y-2">
      ...
      <div className="relative z-10 flex items-center justify-center py-4 transition-transform duration-700 group-hover:scale-110 group-hover:-rotate-3">
        <Image
          ...
          width={450}
          height={450}
          className="w-full h-auto drop-shadow-[0_35px_35px_rgba(236,72,153,0.3)] object-contain"
          priority
        />
      </div>
